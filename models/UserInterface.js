class UserInterface {
    ...
    constructor(document){
        ...
        this.numButtons = addNumberInputDOMButtonEventListenerList(document, "button[data-type = number]")
        this.operatorButtons = addOperatorInputDOMButtonEventListenerMap(document, "button[data-type = operator]")
        this.clearButton = addClearInputDOMButtonEventListener(document, "button[data-type = clear]")
        this.deleteButton = addDeleteInputDOMButtonEventListener(document, "button[data-type = delete]")
        this.commaButton = addCommaInputDOMButtonEventListener(document, "button[data-type = comma]")
        this.changeSignButton = addChangeSignInputDOMButtonEventListener(document, "button[data-type = changeSign]")
        this.equalButton = addEqualInputDOMButtonEventListener(document, "button[data-type = equal]")
    }
